...
def iter_loop_this(qq_1, mm_1, ii_1, jj_1):
    lower_thing, upper_thing = 3*mm_1 + 2 * qq_1 - 0.3, 3*mm_1 + 2 * qq_1 + 1
    resultate = []
    liste_des_fallens = []
    for kk in range(13):
...
if __name__ == "__main__":
    ...
    ii = 0
    mm = 1
    resultate_1, liste_of_sachen = iter_loop_this(-.15, mm, ii, 0)
    ...
    for ii, geo in enumerate(resultate_1[10]):
